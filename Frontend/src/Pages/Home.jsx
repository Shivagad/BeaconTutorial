        ...
        <div className="relative bg-blue-600 text-white overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col items-center space-y-4 md:space-y-6">
            ...
            <p className="text-center text-lg md:text-xl max-w-xl">
              Up to 99% Scholarship for qualifying students from 10th SSC / CBSE
              / ICSE
            </p>
            <button
              onClick={() => {
          ...
          <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4 md:pr-8 z-10">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                being a guiding signal that will bolster the enthusiastic minds
                to their life goals. We started with humble beginnings with a
                mission to revolutionize education and transform young lives.
                With a small classroom in Pune and some students of class 9th
                and 10th, Beacon Tutorials’ teachers made an impact on the way
                teaching is done and results are achieved. The students started
                recommending Us to everyone because they had found the teaching
