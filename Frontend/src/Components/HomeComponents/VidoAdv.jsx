    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/2">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Beacon Tutorial Coaching Institute</h1>
          
          <div className="prose max-w-none">
            <p className="mb-4">
              Welcome to Beacon Tutorial Coaching Institute, your guiding light to academic excellence. 
            ...
            <p className="mb-4">
              At Beacon Tutorial, we believe in a holistic approach to education. Our experienced faculty 
