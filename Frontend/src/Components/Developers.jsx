...
const Developers = () => {
    ...
    const developers = [
        ...
        },
        {
            ...
            linkedin: "https://www.linkedin.com/in/abhijeet-lahase-41769225b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        ...
        <div className="grid grid-cols-1 gap-12 max-w-4xl mx-auto md:grid-cols-2 md:grid-rows-2">
            {teachers.length > 0 && (
                <div className="flex flex-col items-center md:col-span-2 hover:scale-105 transition-transform duration-300">
                    ...
                    />
                    <h3 className="text-xl font-semibold text-gray-800">{teachers[0].name}</h3>
