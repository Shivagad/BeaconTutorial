      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">8, 9, 10 Foundation</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">8, 9, 10 Regular Board Batches</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">CBSE, SSC, ICSE</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">11th + 12th Board Classes</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">11th + 12th JEE Mains + Advance</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">11th + 12th NEET</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">11th + 12th ISSER</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">11th + 12th MHTCET</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">11th + 12th NDA</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">11th + 12th CUET</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">NEET Repeaters</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">JEE (Mains + Advance)</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">NEET</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">NDA</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">MHTCET</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">ISSER</a></li>
              <li><a href="/all-courses" className="text-white hover:text-orange-300 transition-colors">CUET</a></li>
            </ul>
          </div>
