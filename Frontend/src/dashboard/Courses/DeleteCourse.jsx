...
const DeleteCourseModal = ({ isDeleteOpen, onClose, setToast, courseName, id }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (confirmText.toLowerCase() === 'delete') {
      try {
        ...
        setToast({
          success: false,
          message: `Error deleting course: ${error.response?.data?.message || error.message}`,
        });
      }
      setConfirmText('');
      onClose();
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="mb-6">
          <p className="text-gray-600 mb-4">
            Are you sure you want to delete <span className="font-semibold">{courseName}</span>? This action cannot be undone.
          </p>
