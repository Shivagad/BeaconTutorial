...
const DeleteJEEStudentModal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (confirmText.toLowerCase() === 'delete') {
      const response = await axios.delete(`https://beacon-tutorial.vercel.app/server/jee/students/${id}`);
...
export default DeleteJEEStudentModal;
