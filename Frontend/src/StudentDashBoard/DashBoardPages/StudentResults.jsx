...
const StudentResult = () => {
  ...
  return (
    <div className="flex justify-center max-auto">
      <div className="w-[370px] md:w-2/3 bg-white shadow-lg p-6 rounded-lg overflow-x-auto">
        <h2 className="text-2xl font-bold text-[#4E77BB] mb-4">Exam Results</h2>
        ...
        {loading ? (
          ...
          <div className="text-red-600 text-center text-lg">No Result Available</div>
        ) : (
          results.length > 0 ? (
            <table className="w-full border-collapse border border-blue-500 text-sm md:text-base">
              <thead>
                <tr className="bg-[#4E77BB] text-white">
              ...
              <tbody>
                {results.map((result, index) => (
                  <tr key={index} className={index % 2 === 0 ? "bg-white" : "bg-gray-100"}>
                    ...
                    <td
                      className="p-2 border text-center text-[#4E77BB] cursor-pointer hover:underline"
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 pr-4">
            <div className="bg-white p-6 rounded-lg w-11/12 md:w-3/4 lg:w-2/3 max-h-[80vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-[#4E77BB]">{detailedResult.exam} - Detailed Result</h2>
                <button
